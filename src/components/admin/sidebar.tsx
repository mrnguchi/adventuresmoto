...
const links = [ ["/admin/orders", "", "Orders"], ["/admin", "◈", "Overview"], ["/admin/products", "▦", "Products"], ["/admin/categories", "▤", "Categories"], ["/admin/brands", "◇", "Brands"], ["/admin/inventory", "▥", "Inventory"], ["/admin/activity", "↺", "Activity log"] ];
